...
if (!defined('SUFFUSION_THEME_VERSION')) {
	define('SUFFUSION_THEME_VERSION', '4.4.8');
}
...
function suffusion_update_generated_css() {
	...
	if ((!isset($custom_css) || (isset($custom_css) && !is_array($custom_css)) ||
			...
			&& isset($db_options) && is_array($db_options) && count($db_options) > 10) {
		$custom_css = array();
...
function suffusion_customize_register($wp_customize) {
	...
	$wp_customize->add_setting(
		...
		array(
			...
			'sanitize_callback' => 'suffusion_sanitize_color_scheme',
		)
	);
...
function suffusion_sanitize_color_scheme($value) {
	if (!in_array($value, array('scribbles', 'photonique', 'minima', 'light-theme-green', 'dark-theme-green', 'light-theme-pale-blue', 'dark-theme-pale-blue',
				'light-theme-royal-blue', 'dark-theme-royal-blue', 'light-theme-gray-1', 'dark-theme-gray-1', 'light-theme-gray-2', 'dark-theme-gray-2', 
				'light-theme-red', 'dark-theme-red', 'light-theme-orange', 'dark-theme-orange', 'light-theme-purple', 'dark-theme-purple', ))) {
		return 'light-theme-gray-1';
	}
	return $value;
}
